...
efas_stations = "metastation315.txt"
shapefolder = "../shape_3sec/shape_3sec_no_"
upsname = "../data/ups_danube_3sec.tif"

#OUTPUT
efas_Merit = "efas_Merit_2.txt"
...
for stationNo in range(len(efas)):
    ...
    coord = [float(station[13]), float(station[14])]
    # lat lon
    efas_no =  station[1]
    ...
    col1 = int((coord[1] - left) * invcell + 0.000001)
    row1 = int((top -coord[0]) * invcell + 0.000001)
    ups1 = ups[row1,col1]
