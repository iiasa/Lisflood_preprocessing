...
def coordinates_coarse(
    ...
    try: 
        flwdir, resolution = read_flowdir(cfg.flwdir_coarse, ftype='ldd')
    ...
    for ID, point in tqdm(points_fine.iterrows(), total=n_points, desc='points'):
        ...
        try:
            ...
            basins, shape_error = compute_shape_error(flwdir, idxs, polygons_fine.loc[[ID]])
